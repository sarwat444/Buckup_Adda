            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="buttons d-flex mb-3">
                        <a href="{{route('dashboard.mokasherat_gehat_report' ,['kheta_id'=>$kheta_id , 'year_id' => $year_id , 'part' => 1])}}"
                        ...
                        <a href="{{route('dashboard.mokasherat_gehat_report' ,['kheta_id'=>$kheta_id ,  'year_id' => $year_id, 'part' => 2])}}"
                        ...
                        <a href="{{route('dashboard.mokasherat_gehat_report' ,['kheta_id'=>$kheta_id ,   'year_id' => $year_id , 'part' => 3])}}"
                        ...
                        <a href="{{route('dashboard.mokasherat_gehat_report' ,['kheta_id'=>$kheta_id ,   'year_id' =>$year_id , 'part' => 4])}}"
                ...
                <div class="card-body">
                    @if(!empty($results))
                        <a class="btn btn-primary mb-2"
                           onclick="printReport('{{ $kheta_id }}', '{{ $year_id }}'  , '{{ $part }}')"> <i
