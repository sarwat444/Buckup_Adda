 ...
 Route::get('send-mail' , [MailController::class , 'index'])->name('send_mail') ;
  ...
  Route::resource('Permissions', permissionController::class);
   ...
   Route::post('gehat_targets_report' ,[DashboardController::class ,'gehat_targets_report']);
    ...
    Route::get('print_gehat_targets_report2/{kheta_id}/{year_id?}/{part?}' ,[DashboardController::class ,'print_gehat_targets_report2'])->name('print_gehat_targets_report2') ;
   ...
   Route::get('mokasherat_wezara/{kheta_id}/{year_id?}/{part?}' ,[DashboardController::class ,'mokasherat_wezara'])->name('mokasherat_wezara');
    ...
    Route::get('print_gehat_mokasherat2/{kheta_id}/{year_id}' ,[DashboardController::class ,'print_gehat_mokasherat2'])->name('print_gehat_mokasherat2');
    ...
    Route::get('/print_Histogram_kheta_objectives_dashboard/{kheta_id}/{year_id?}' , [DashboardController::class, 'print_Histogram_kheta_objectives_dashboard'])->name('print_Histogram_kheta_objectives_dashboard');
